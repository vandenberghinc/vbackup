...
if (info_item.attrs){
info_item.attributes=info_item.attrs;
delete info_item.attrs;
}
...
if (info_item.callback){
const err=info_item.callback(params[info_keys[x]]);
if (err){
return throw_err_h(`${error_prefix}${err}`,info_keys[x]);
}
}
}
}
